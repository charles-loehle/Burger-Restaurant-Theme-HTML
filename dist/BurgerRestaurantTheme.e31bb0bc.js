...
function scrollFunction() {
  ...
  if ((typeof window.scrollY === 'undefined' ? window.pageYOffset : window.scrollY) > aboutSectionYcoord - 600) {
...
window.addEventListener('scroll', function () {
  ...
  sections.forEach(function (section) {
    ...
    var sectionTop = section.offsetTop; //console.log('sectionTop: ' + sectionTop);
    // get the height of each section

    var sectionHeight = section.clientHeight; //console.log('section height: ' + sectionHeight);
...
var navLinks = document.querySelectorAll('nav.open ul li'); // click on the hamburger menu to open and close nav drawer
...
},{"./scss/style.scss":"scss/style.scss","./js/stickyNav.js":"js/stickyNav.js","./js/navHighlighting.js":"js/navHighlighting.js","./js/hamburger.js":"js/hamburger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/BurgerRestaurantTheme.e31bb0bc.js.map